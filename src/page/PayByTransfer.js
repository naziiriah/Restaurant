    ...
    <>
      <header>
        <div className="container bill-header header">
          <i className="fa-solid fa-angle-left" onClick={() => navigate('/bill')}></i>
      ...
      <main>
        <section className="transfer__section">
          <h3>
            Transfer <span>&#x20A6;{myBill.toLocaleString('en-US')}</span> to the account details
            below
          </h3>
          ...
          <div className="transfer__expires">
            ...
            <p className="transfer__expires--note">
              ...
              This account is for a <span>one time use</span>.
            </p>
          </div>
        </section>
        <section className="transfer__button">
          <button className="btn btn--light" onClick={confirmPayment}>
